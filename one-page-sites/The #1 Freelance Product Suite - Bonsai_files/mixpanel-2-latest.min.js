(function() {
  ...
  (function() {
    function U(a) {
      function b() {
        try {
          (a.D = a.D || {}), (a.D.$__c = (a.D.$__c || 0) + 1), c.cookie.set(
            "mp_" + d + "__c",
            a.D.$__c,
            1,
            m
    ...
    function V() {
      ...
      if (document.addEventListener)
        "complete" === document.readyState
          ? a()
          : document.addEventListener("DOMContentLoaded", a, r);
    ...
    function H(a, b, d) {
      ...
      if (e.c("autotrack")) {
        F.Zc(e.c("token"), 100, 100)
          ? F.dd()
            ? F.U(e)
            : (
                (e.__autotrack_enabled = r),
                k.log(
      ...
      !c.d(f) && c.isArray(f) && (e.Ka.call(e.people, f.people), e.Ka(f));
      return e;
    }
    function p() {}
    function h() {}
    function o(a) {
      ...
      if ((b = "localStorage" === b)) {
        b = m;
        try {
          c.localStorage.set("__mplssupport__", "xyz"), "xyz" !==
            c.localStorage.get("__mplssupport__") &&
            (b = r), c.localStorage.remove("__mplssupport__");
        } catch (d) {
          b = r;
        }
    ...
    c.bind = function(a, b) {
      var d, e;
      if (N && a.bind === N) return N.apply(a, D.call(arguments, 1));
      if (!c.bb(a)) throw new TypeError();
      d = D.call(arguments, 2);
      return (e = function() {
        ...
        var j = new c();
        c.prototype = n;
        c = a.apply(j, d.concat(D.call(arguments)));
    ...
    c.a = function(a, b, d) {
      if (!(a === n || void 0 === a))
        if (S && a.forEach === S) a.forEach(b, d);
          ...
          for (
            var c = 0, f = a.length;
            c < f && !(c in a && b.call(d, a[c], c, a) === O);
            c++
          );
        else
          for (c in a) if (J.call(a, c) && b.call(d, a[c], c, a) === O) break;
    };
    c.K = function(a) {
      a &&
        c.cb(a) &&
    ...
    c.extend = function(a) {
      c.a(D.call(arguments, 1), function(b) {
    ...
    c.ja = function(a) {
      return !a
        ? []
        : a.ja ? a.ja() : c.isArray(a) || c.cd(a) ? D.call(a) : c.Fd(a);
    };
    c.Fd = function(a) {
      var b = [];
      if (a === n) return b;
    ...
    c.Lb = function(a, b) {
      var d = r;
      if (a === n) return d;
      if (T && a.indexOf === T) return -1 != a.indexOf(b);
      c.a(a, function(a) {
        if (d || (d = a === b)) return O;
      });
      return d;
    ...
    c.V = function(a) {
      if (c.j(a)) {
        for (var b in a) if (J.call(a, b)) return r;
        return m;
      }
      return r;
    };
    ...
    c.Ib = function(a) {
      c.a(a, function(b, d) {
        c.ed(b) ? (a[d] = c.$c(b)) : c.j(b) && (a[d] = c.Ib(b));
      });
      return a;
    };
    ...
    c.ma = (function() {
      function a() {
        switch (i) {
          ...
          case "f":
            return f("f"), f("a"), f("l"), f("s"), f("e"), r;
          case "n":
            return f("n"), f("u"), f("l"), f("l"), n;
        }
        j('Unexpected "' + i + '"');
      }
      function b() {
      ...
      function j(a) {
        throw { name: "SyntaxError", message: a, Jd: l, text: h };
      }
      var l,
        i,
        g = {
            ...
            a: {
              ...
              if ("{" === i) {
                ...
                for (; i; ) {
                  ...
                  b();
                  f(":");
                  Object.hasOwnProperty.call(h, g) &&
                    j('Duplicate key "' + g + '"');
                  h[g] = q();
                  b();
                  if ("}" === i) {
    ...
    c.Ab = function(a) {
      ...
      a = c.Ed(a);
      do
        (b = a.charCodeAt(j++)), (d = a.charCodeAt(j++)), (e = a.charCodeAt(
          j++
        )), (f = (b << 16) | (d << 8) | e), (b = (f >> 18) & 63), (d =
          (f >> 12) & 63), (e = (f >> 6) & 63), (f &= 63), (i[l++] =
    ...
    c.Ed = function(a) {
      ...
      for (j = 0; j < f; j++) {
        ...
        128 > l
          ...
          : (i =
              127 < l && 2048 > l
                ? String.fromCharCode((l >> 6) | 192, (l & 63) | 128)
                : String.fromCharCode(
                    (l >> 12) | 224,
                    ((l >> 6) & 63) | 128,
                    (l & 63) | 128
        ...
        i !== n &&
          (c > d && (b += a.substring(d, c)), (b += i), (d = c = j + 1));
      }
    ...
    c.kb = (function() {
      function a() {
        function a(b, c) {
          var d,
            f = 0;
          for (d = 0; d < c.length; d++) f |= j[d] << (8 * d);
          return b ^ f;
        }
        var b,
          c,
        ...
        for (b = 0; b < t.length; b++)
          (c = t.charCodeAt(b)), j.unshift(c & 255), 4 <= j.length &&
            ((l = a(l, j)), (j = []));
        0 < j.length && (l = a(l, j));
    ...
    c.Jb = function(a, b) {
      var b = b.replace(/[\[]/, "\\[").replace(/[\]]/, "\\]"),
        c = RegExp("[\\?&]" + b + "=([^&#]*)").exec(a);
      return c === n || (c && "string" !== typeof c[1] && c[1].length)
        ? ""
    ...
    c.cookie = {
      ...
      Md: function(a, b, c, e, f) {
        ...
        e &&
          (
            (d = (j = (j = v.location.hostname.match(
    ...
    c.o = (function() {
      ...
      function b(a) {
        if (a)
          (a.preventDefault = b.preventDefault), (a.stopPropagation =
            b.stopPropagation);
        return a;
      }
      ...
      return function(b, c, f, j, l) {
        b
          ? b.addEventListener && !j
            ? b.addEventListener(c, f, !!l)
            : ((c = "on" + c), (b[c] = a(b, f, b[c])))
          : k.error("No valid element provided to register_event");
      };
    })();
    c.Xc = (function() {
      function a(a, b) {
        ...
        for (i = 0; i < b.length; i++)
          if (
            ...
            for (g = l = 0; g < k.length; g++) {
              q =
                "*" == d
                  ? k[g].all ? k[g].all : k[g].getElementsByTagName("*")
                  : k[g].getElementsByTagName(d);
              for (h = 0; h < q.length; h++) j[l++] = q[h];
            }
            k = [];
            for (g = d = 0; g < j.length; g++)
              j[g].className &&
                c.cb(j[g].className) &&
                a(j[g], o) &&
                (k[d++] = j[g]);
            ...
            switch (o) {
              ...
              case "$":
                o = function(a) {
                  return (
                    a.getAttribute(p).lastIndexOf(A) ==
                    a.getAttribute(p).length - A.length
                  );
                };
                break;
              case "*":
            ...
            k = [];
            for (g = d = 0; g < j.length; g++) o(j[g]) && (k[d++] = j[g]);
          } else {
            j = [];
            for (g = l = 0; g < k.length; g++) {
      ...
      var d = /[\t\r\n]/g;
      return function(a) {
        return c.fd(a) ? [a] : c.j(a) && !c.d(a.length) ? a : b.call(this, a);
      };
    })();
    c.info = {
      Qc: function() {
      ...
      ba: function(a, b, d) {
        return d || c.g(a, " OPR/")
          ? c.g(a, "Mini") ? "Opera Mini" : "Opera"
          : /(BlackBerry|PlayBook|BB10)/i.test(a)
            ? "BlackBerry"
            : c.g(a, "IEMobile") || c.g(a, "WPDesktop")
              ...
              : c.g(a, "Edge")
                ...
                : c.g(a, "FBIOS")
                  ...
                  : c.g(a, "Chrome")
                    ...
                    : c.g(a, "CriOS")
                      ? "Chrome iOS"
                      : c.g(a, "UCWEB") || c.g(a, "UCBrowser")
                        ? "UC Browser"
                        : c.g(a, "FxiOS")
                          ? "Firefox iOS"
                          : c.g(b || "", "Apple")
                            ? c.g(a, "Mobile") ? "Mobile Safari" : "Safari"
                            : c.g(a, "Android")
                              ? "Android Mobile"
                              : c.g(a, "Konqueror")
                                ? "Konqueror"
      ...
      gb: function() {
        return /Windows/i.test(t)
          ? /Phone/.test(t) || /WPDesktop/.test(t) ? "Windows Phone" : "Windows"
          : /(iPhone|iPad|iPod)/.test(t)
            ...
            : /Android/.test(t)
              ...
              : /(BlackBerry|PlayBook|BB10)/i.test(t)
                ? "BlackBerry"
                : /Mac/i.test(t) ? "Mac OS X" : /Linux/.test(t) ? "Linux" : "";
      },
      Hb: function(a) {
      ...
      ha: function() {
        return c.extend(
          c.za({
            $os: c.info.gb(),
            $browser: c.info.ba(t, E.vendor, window.opera),
            $referrer: v.referrer,
          ...
          }),
          {
            ...
            $browser_version: c.info.Db(t, E.vendor, window.opera),
      ...
      kd: function(a) {
        return c.za({
          ...
          mp_browser: c.info.ba(t, E.vendor, window.opera),
    ...
    var F = {
      ...
      Ec: function(a, b) {
        ...
        0 < e.length
          ? e[0].parentNode.insertBefore(c, e[0])
      ...
      qa: function(a) {
        switch (typeof a.className) {
          case "string":
            return a.className;
          case "object":
            return a.className.Kd || a.getAttribute("class") || "";
          default:
            return "";
        }
      },
      xc: function(a) {
        ...
        for (var e = (d = 1), f = a; (f = this.Hc(f)); )
          d++, f.tagName === a.tagName && e++;
        b.nth_child = d;
        b.nth_of_type = e;
        return b;
      },
      ...
      Ma: function(a, b) {
        ...
        return /^cc|cardnum|ccnum|creditcard|csc|cvc|cvv|exp|pass|seccode|securitycode|securitynum|socialsec|socsec|ssn/i.test(
          (a.name || a.id || "").replace(/[^a-zA-Z0-9]/g, "")
        ) ||
        ("string" === typeof b &&
          ...
          function(a) {
            ...
            if (c !== n) {
              var c = "$form_field__" + c,
                f = this.qb(a);
              this.Ma(a, f) &&
                ((a = b[c]), (b[c] = void 0 !== a ? [].concat(a, f) : f));
            }
          },
          this
        );
      ...
      rc: function(a) {
        ...
        c.a(document.querySelectorAll(a.css_selector), function(a) {
          -1 < ["input", "select"].indexOf(a.tagName.toLowerCase())
            ? b.push(a.value)
      ...
      Lc: function(a, b) {
        ...
        if (this.Jc(d, a)) {
          for (var e = [d]; d.parentNode && !this.Oa(d, "body"); )
          ...
          c.a(
            ...
            function(a, b) {
              "a" === a.tagName.toLowerCase()
                ...
                : "form" === a.tagName.toLowerCase() && (i = a);
          ...
          e = c.extend(
            this.pb(a.type),
            { $elements: f, $el_attr__href: j, $el_text: g },
            this.tc(e)
          );
          i &&
            ("submit" === a.type || "click" === a.type) &&
            c.extend(e, this.vc(i));
          b.I("$web_event", e);
          return m;
        }
      },
      ...
      U: function(a) {
        if (!document || !document.body) {
          ...
          var d = a.c("token");
          if (-1 < this.tb.indexOf(d))
            console.log('autotrack already initialized for token "' + d + '"');
          else if ((this.tb.push(d), !this.Fc(a))) {
            var e = c.bind(function(b) {
              if (b && b.config && b.config.enable_collect_everything === m) {
                ...
                a.I(
                  "$web_event",
                  c.extend({ $title: document.title }, this.pb("pageview"))
                );
                this.mc(a);
            ...
            a.p(
              a.c("api_host") + "/decide/",
              { verbose: m, version: "1", lib: "web", token: d },
              a.ta(e)
            );
          }
        }
      ...
      nb: function(a, b) {
        ...
        try {
          ...
          e.desiredHash
            ? (window.location.hash = e.desiredHash)
            : window.history
      ...
      Fc: function(a) {
        try {
          var b = r;
          if (c.ea(window.location.hash, "state"))
            var d = c.ea(window.location.hash, "state"),
              d = JSON.parse(decodeURIComponent(d)),
              b = "mpeditor" === d.action;
          var e = !!window.sessionStorage.getItem("_mpcehash"),
            f;
          b
            ? (f = this.nb(a, window.location.hash))
            : e
              ? (
                  (f = this.nb(a, window.sessionStorage.getItem("_mpcehash"))),
                  window.sessionStorage.removeItem("_mpcehash")
                )
              : (f = JSON.parse(
                  window.sessionStorage.getItem("editorParams") || "{}"
                ));
          return f.projectToken && a.c("token") === f.projectToken
            ? (this.Dc(a, f), m)
            : r;
        } catch (j) {
          return r;
      ...
      Dc: function(a, b) {
        return !window._mpEditorLoaded
          ? (
              (window._mpEditorLoaded = m),
              this.Ec(
                a.c("app_host") +
      ...
      Zc: function(a, b, d) {
        for (
          var b = !c.d(b) ? b : 10, d = !c.d(d) ? d : 10, e = 0, f = 0;
          f < a.length;
          f++
        )
          e += a.charCodeAt(f);
    ...
    var L,
      s,
      Y = "__mps,__mpso,__mpa,__mpap,__mpu,$people_distinct_id,__alias,__cmpns,__timers".split(
        ","
      );
    w = "https:" === document.location.protocol ? "https://" : "http://";
    var K = window.XMLHttpRequest && "withCredentials" in new XMLHttpRequest(),
      Q = !K && -1 === t.indexOf("MSIE") && -1 === t.indexOf("Mozilla"),
      Z = {
    ...
    x.prototype.I = function(a, b, d, e) {
      var f = this,
        j = c.Xc(a);
      if (0 === j.length)
        k.error("The DOM query (" + a + ") returned 0 elements");
      else
        return c.a(
          j,
          function(a) {
            c.o(a, this.Tb, function(a) {
              var c = {},
                j = f.wa(d, this),
                g = f.Rb.c("track_links_timeout");
              f.Wa(a, this, c);
              window.setTimeout(f.$b(e, j, c, m), g);
              f.Rb.I(b, j, f.$b(e, j, c));
            });
          },
          this
        ), m;
    ...
    x.prototype.$b = function(a, b, c, e) {
      var e = e || r,
        f = this;
      return function() {
        if (!c.Pc) (c.Pc = m), (a && a(e, b) === r) || f.Sa(b, c, e);
      };
    };
    ...
    C.prototype.wa = function(a, b) {
      var c = C.xd.wa.apply(this, arguments);
    ...
    o.prototype.Dd = function(a) {
      var b = a.upgrade,
        d;
      if (b)
        (d = "mp_super_properties"), "string" === typeof b &&
          (d = b), (b = this.v.parse(d)), this.v.remove(d), this.v.remove(
          d,
          m
      ...
      if (
        !a.cookie_name &&
        "mixpanel" !== a.name &&
        ((d = "mp_" + a.token + "_" + a.name), (b = this.v.parse(d)))
      )
        this.v.remove(d), this.v.remove(d, m), this.F(b);
    ...
    o.prototype.save = function() {
      this.disabled ||
        (
          this.qc(),
          this.v.set(this.name, c.na(this.props), this.Xa, this.Ua, this.Vb)
        );
    };
    ...
    o.prototype.F = function(a, b, d) {
      return c.j(a)
        ? (
            ...
            (this.Xa = "undefined" === typeof d ? this.Gb : d),
            c.a(
              a,
              function(a, c) {
    ...
    o.prototype.ia = function(a, b) {
      return c.j(a)
        ? (
            (this.Xa = "undefined" === typeof b ? this.Gb : b),
    ...
    o.prototype.Cd = function() {
      if (!this.Eb) this.F(c.info.Qc()), (this.Eb = m);
    };
    ...
    o.prototype.cc = function(a) {
      this.Gb = this.Xa = a.cookie_expiration;
      this.sd(a.disable_persistence);
    ...
    o.prototype.rd = function(a) {
      if (a !== this.Ua) (this.Ua = a), this.remove(), this.save();
    };
    o.prototype.ad = function() {
      return this.Ua;
    };
    ...
    o.prototype.A = function(a, b) {
      var d = this.La(a),
        ...
        h = this.Z("$append", []);
      "__mps" === d
        ? (c.extend(f, e), this.S("$add", e), this.S("$union", e))
        : "__mpso" === d
          ? c.a(e, function(a, b) {
              b in j || (j[b] = a);
            })
    ...
    h.prototype.U = function(a, b, d) {
      if (c.d(d))
        k.error("You must name your new library: init(token, config, name)");
      else if ("mixpanel" === d)
        k.error(
    ...
    h.prototype.Na = function(a, b, d) {
      ...
      this.Ja = [];
      this.Ha = [];
      this.P = { disable_all_events: r, identify_called: r };
      this.persistence = this.cookie = new o(this.config);
      this.F({ distinct_id: c.kb() }, "");
    };
    ...
    h.prototype.Qa = function(a, b) {
      ...
      if (!P) return this.Ia.push([a, b]), r;
      var c = new a().U(this);
          ...
          try {
            ...
            j.onreadystatechange = function() {
              if (4 === j.readyState)
                if (200 === j.status)
                  d &&
                    (e ? d(c.ma(j.responseText)) : d(Number(j.responseText)));
                else {
                  var a = "Bad HTTP status: " + j.status + " " + j.statusText;
                  k.error(a);
      ...
      if (c.d(a)) k.error("No event name provided to mixpanel.track");
        ...
        try {
          if (
            ...
            (b = c.extend({}, b, this.D)), (this.D = { $__c: 0 }), c.cookie.set(
              "mp_" + this.c("name") + "__c",
              0,
              1,
              m
        ...
        k.log(a);
        this.p(this.c("api_host") + "/track/", { data: e }, this.ta(d, a));
        return a;
      }
    };
    h.prototype.ac = function(a) {
      if (c.d(a)) a = document.location.href;
      this.I("mp_page_view", c.info.kd(a));
    };
    h.prototype.Bd = function() {
      return this.Qa.call(this, C, arguments);
    };
    h.prototype.Ad = function() {
      return this.Qa.call(this, I, arguments);
    };
    h.prototype.yd = function(a) {
      c.d(a)
        ? k.error("No event name provided to mixpanel.time_event")
        : this.ob(a) || this.persistence.td(a);
    };
    ...
    h.prototype.Za = function(a, b, c, e, f, j) {
      a !== this.T() &&
        a !== this.xa("__alias") &&
        (this.Ca("__alias"), this.Pa("distinct_id", a));
      this.lb(this.T());
      this.P.$a = m;
      this.people.sc(b, c, e, f, j);
    };
    ...
    h.prototype.Nc = function(a, b) {
      if (a === this.xa("$people_distinct_id"))
        return k.ca(
      ...
      c.d(b) && (b = this.T());
      if (a !== b)
        return this.Pa("__alias", a), this.I(
          "$create_alias",
    ...
    h.prototype.Wb = function(a) {
      if (c.j(a))
        c.extend(this.config, a), this.c("persistence_name") ||
          (this.config.persistence_name = this.config.cookie_name), this.c(
          "disable_persistence"
        ) ||
          (this.config.disable_persistence = this.config.disable_cookie), this
          .persistence && this.persistence.cc(this.config), (z =
          z || this.c("debug"));
    };
    ...
    h.prototype.ob = function(a) {
      return c.Ob(t) || this.P.Uc || c.Lb(this.Ha, a);
    };
    ...
    p.prototype.set = function(a, b, d) {
      ...
      f = c.extend({}, c.info.ld(), this.e.persistence.bd(), f);
      e.$set = f;
      return this.p(e, d);
    };
    ...
    p.prototype.zd = function(a, b, d) {
      if (!c.gd(a) && ((a = parseFloat(a)), isNaN(a))) {
        k.error(
    ...
    p.prototype.Tc = function() {
      if (this.sb()) return this.p({ $delete: this.e.T() });
      k.error(
    ...
    p.prototype.p = function(a, b) {
      ...
      var d = c.Ib(a),
        ...
        d = c.Ab(d);
      if (!this.sb())
        return this.pc(a), c.d(b) ||
          (this.ra("verbose") ? b({ status: -1, error: n }) : b(-1)), e;
      k.log("MIXPANEL PEOPLE REQUEST:");
      k.log(e);
      this.e.p(this.ra("api_host") + "/engage/", { data: d }, this.e.ta(b, e));
      return e;
    };
    ...
    p.prototype.pc = function(a) {
      "$set" in a
        ? this.e.persistence.A("$set", a)
        : "$set_once" in a
          ? this.e.persistence.A("$set_once", a)
          : "$add" in a
            ? this.e.persistence.A("$add", a)
            : "$append" in a
              ? this.e.persistence.A("$append", a)
              : "$union" in a
                ? this.e.persistence.A("$union", a)
                : k.error("Invalid call to _enqueue():", a);
    };
    p.prototype.sc = function(a, b, d, e, f) {
      var g = this,
      ...
      !c.d(h) &&
        ...
        !c.V(h) &&
        (
          g.e.persistence.S("$set", h),
          this.set(h, function(b, d) {
            0 === b && g.e.persistence.A("$set", h);
            c.d(a) || a(b, d);
          })
        );
      !c.d(i) &&
        ...
        !c.V(i) &&
        (
          g.e.persistence.S("$set_once", i),
          this.Xb(i, function(a, b) {
            0 === a && g.e.persistence.A("$set_once", i);
            c.d(e) || e(a, b);
          })
        );
      !c.d(k) &&
        ...
        !c.V(k) &&
        (
          g.e.persistence.S("$add", k),
          this.Mb(k, function(a, d) {
            0 === a && g.e.persistence.A("$add", k);
            c.d(b) || b(a, d);
          })
        );
      !c.d(q) &&
        ...
        !c.V(q) &&
        (
          g.e.persistence.S("$union", q),
          this.bc(q, function(a, b) {
            0 === a && g.e.persistence.A("$union", q);
            c.d(f) || f(a, b);
          })
        );
      if (!c.d(o) && c.isArray(o) && o.length) {
        for (
          var p,
            s = function(a, b) {
              0 === a && g.e.persistence.A("$append", p);
              c.d(d) || d(a, b);
            },
            t = o.length - 1;
          0 <= t;
          ...
          (p = o.pop()), g.append(p, s);
        g.e.persistence.save();
      }
    };
    ...
    h.lc = function(a, b) {
      ...
      this.C = c.K(a.id);
      this.Qb = c.K(a.message_id);
      this.body = (c.K(a.body) || "").replace(/\n/g, "<br/>");
      this.Sc = c.K(a.cta) || "Close";
    ...
    g.prototype.show = function() {
      ...
      this.xb();
      this.q
        ? (this.Bc(), this.Ac(), this.Gc(this.nc))
        : setTimeout(function() {
            a.show();
          }, 300);
    };
    g.prototype.Va = c.l(function() {
      this.Pb || this.vb({ invisible: m });
      var a = this.vd ? this.i("video") : this.Q();
      if (this.ec)
        this.Ic("bg", "visible"), this.N(a, "exiting"), setTimeout(
          this.wb,
          g.M
        );
      else {
        ...
        this.u
          ? ((b = "right"), (c = 20), (e = -100))
          : ((b = "top"), (c = g.H), (e = g.oa + g.H));
        this.pa(
          [
            { s: this.i("bg"), m: "opacity", start: g.la, k: 0 },
            { s: a, m: "opacity", start: 1, k: 0 },
            { s: a, m: b, start: c, k: e }
          ],
          g.M,
          this.wb
    ...
    g.prototype.N = c.l(function(a, b) {
      b = g.w + "-" + b;
    ...
    g.prototype.Ic = c.l(function(a, b) {
      b = g.w + "-" + b;
      "string" === typeof a && (a = this.i(a));
      if (a.className)
    ...
    g.prototype.pa = c.l(function(a, b, c, e) {
      var f = this,
        g = r,
        h,
        i;
      ...
      if (g) {
        for (h = 0; h < a.length; h++)
          (i = a[h]), i.s &&
            (i.s.style[i.m] = "" + i.G + ("opacity" === i.m ? "" : "px"));
        setTimeout(function() {
          f.pa(a, b, c, e);
        }, 10);
      } else c && c();
    });
    g.prototype.nc = c.l(function() {
      var a = this;
      if (!this.wd && !this.rb()[this.C])
        (this.wd = m), this.q.appendChild(this.ga), setTimeout(function() {
          var b = a.Q();
          if (a.ec) a.u || a.N("bg", "visible"), a.N(b, "visible"), a.ub();
          else {
            var c, e, f;
            a.u
              ? ((c = "right"), (e = -100), (f = 20))
              : ((c = "top"), (e = g.oa + g.H), (f = g.H));
            a.pa(
              [
                { s: a.i("bg"), m: "opacity", start: 0, k: g.la },
                { s: b, m: "opacity", start: 0, k: 1 },
                { s: b, m: c, start: e, k: f }
              ],
              g.M,
              a.ub
          ...
          b.preventDefault();
          a.W
            ? (a.Ra("$campaign_open", { $resource_type: "video" }), a.Kc())
            : (
                a.Va(),
                a.va &&
                  a.Ra(
    ...
    g.prototype.i = function(a) {
      return document.getElementById(g.w + "-" + a);
    };
      ...
      this.u
        ...
        : (
            this.ab
              ? (
                  a.push(this.ab),
                  (this.Kb = '<img id="img" src="' + this.ab + '"/>')
                )
              : (this.Kb = ""),
            this.L
              ? (
                  a.push(this.L),
                  (this.Zb =
                    '<div id="thumbborder-wrapper"><div id="thumbborder"></div></div><img id="thumbnail" src="' +
                    this.L +
                    '" width="' +
                    g.J +
                    '" height="' +
    ...
    g.prototype.Ac = function() {
      ...
      this.ga.id = g.w + "-wrapper";
      if (this.u)
        a =
          '<div id="mini"><div id="mainbox"><div id="cancel"><div id="cancel-icon"></div></div><div id="mini-content"><div id="mini-icon"><div id="mini-icon-img"></div></div><div id="body"><div id="body-text"><div>' +
          this.body +
          '</div></div></div></div></div><div id="mini-border"></div></div>';
      else {
        ...
        a =
          '<div id="takeover">' +
          this.Zb +
          '<div id="mainbox"><div id="cancel"><div id="cancel-icon"></div></div><div id="content">' +
          this.Kb +
          '<div id="title">' +
          this.title +
          '</div><div id="body">' +
          this.body +
          '</div><div id="tagline"><a href="http://mixpanel.com?from=inapp" target="_blank">POWERED BY MIXPANEL</a></div></div><div id="button">' +
          a +
      ...
      if (this.W)
        (this.Gd =
          ...
          '"  src="' +
          b +
          '" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen="1" scrolling="no"></iframe>'), (c =
          '<div id="video-' +
          (this.Ya ? "" : "no") +
          'flip"><div id="video"><div id="video-holder"></div>' +
          c +
          "</div></div>");
      b = c + a;
      this.Ya &&
        (b =
          ...
          (this.u ? c : b) +
          "</div></div>");
      this.ga.innerHTML = ('<div id="overlay" class="' +
        this.fa +
        '"><div id="campaignid-' +
        this.C +
        '"><div id="bgwrapper"><div id="bg"></div>' +
        b +
        "</div></div></div>")
    ...
    g.prototype.Bc = function() {
      ...
      this.u && (a = "none");
      var j = {};
      j["@media only screen and (max-width: " + (g.Ea + 20 - 1) + "px)"] = {
      ...
      a = {
        ...
        "#bg": {
          ...
          width: "100%",
          height: "100%",
          "min-width": 4 * this.Wc + "px",
          "min-height": 4 * this.Vc + "px",
        ...
        "#takeover": {
          ...
          left: "50%",
          width: g.Y + "px",
          "margin-left": Math.round(-g.Y / 2) + "px",
        ...
        "#takeover.visible": { opacity: "1.0", top: g.H + "px" },
        "#takeover.exiting": { opacity: "0.0", top: g.oa + "px" },
        "#thumbspacer": { height: g.Ga + "px" },
        "#thumbborder-wrapper": {
          position: "absolute",
          top: -g.Fa + "px",
          left: g.Y / 2 - g.Ga - g.Fa + "px",
          width: e + "px",
          height: e / 2 + "px",
          overflow: "hidden"
        },
        ...
        "#mini:hover #mini-icon": { "background-color": this.h.eb },
        "#mini:hover #mainbox": { "background-color": this.h.eb },
        "#mini-icon-img": {
          position: "absolute",
        ...
        "#video-noflip": { position: "relative", top: 2 * -this.X + "px" },
        "#video-flip": {
          "backface-visibility": "hidden",
        ...
        "#video.exiting": { opacity: "0.0", top: this.X + "px" },
        "#video-holder": {
          position: "absolute",
          width: this.ka - 1 + "px",
          height: this.X + "px",
        ...
        "#video-frame": { "margin-left": "-1px", width: this.ka + "px" },
      ...
      for (h in a)
        for (e = 0; e < b.length; e++)
          if (((f = b[e]), f in a[h]))
            for (var i = a[h][f], k = 0; k < d.length; k++)
              a[h]["-" + d[k] + "-" + f] = i;
      (function(a, b) {
        function c(a) {
          var b = "",
    ...
    g.prototype.Cc = c.l(function() {
      if (this.Da) {
        ...
        if (b) {
          if (((a.W = m), (a.gc = b[1]), a.hc))
            (window.onYouTubeIframeAPIReady = function() {
              a.i("video-frame") && a.zb();
            }), (b = document.createElement("script")), (b.src =
              "//www.youtube.com/iframe_api"), (c = document.getElementsByTagName(
              "script"
    ...
    g.prototype.ub = c.l(function() {
      function a(a, b) {
        var c = {};
        if (document.defaultView && document.defaultView.getComputedStyle)
          c = document.defaultView.getComputedStyle(a, n);
      ...
      if (this.C) {
        ...
        d &&
          "hidden" !== a(d, "visibility") &&
          "none" !== a(d, "display") &&
          this.vb();
      }
    });
    g.prototype.vb = c.l(function(a) {
      if (!this.Pb)
        (this.Pb = m), this.C &&
          ((this.rb()[this.C] = 1 * new Date()), this.hb.save()), this.Ra(
          "$campaign_delivery",
          a
        ), this.fb.people.append({
          $campaigns: this.C,
          $notifications: {
            campaign_id: this.C,
            message_id: this.Qb,
    ...
    g.prototype.Gc = function(a) {
      ...
      if (0 === this.ya.length) a();
        ...
        this.O("ie", 7) &&
          setTimeout(function() {
            var b = m;
            for (g = 0; g < e.length; g++) e[g].complete || (b = r);
            b && a && (a(), (a = n));
          }, 500);
      }
    };
    g.prototype.wb = c.l(function() {
    ...
    g.prototype.xb = function() {
      function a(a) {
        ...
        if (!c)
          for (
            var a = a[0].toUpperCase() + a.slice(1),
              a = ["O" + a, "Webkit" + a, "Moz" + a],
              b = 0;
            b < a.length;
            b++
          )
      ...
      !this.B.ie &&
        ...
        (this.B.ie = 11);
      if ((this.q = document.body || document.getElementsByTagName("body")[0]))
        (this.Wc = Math.max(
          this.q.scrollWidth,
      ...
      this.Ya =
        (33 <= this.B.chrome || 15 <= this.B.firefox) &&
        this.q &&
    ...
    g.prototype.Kc = c.l(function() {
      ...
      var b = this,
        c = [
          { s: b.Q(), m: "opacity", start: 1, k: 0 },
          { s: b.Q(), m: "top", start: g.H, k: -500 },
          { s: b.i("video-noflip"), m: "opacity", start: 0, k: 1 },
          { s: b.i("video-noflip"), m: "top", start: 2 * -b.X, k: 0 }
        ];
      if (b.u) {
        var e = b.i("bg"),
          f = b.i("overlay");
        ...
        b.N(b.Q(), "exiting");
        b.N(e, "visible");
        c.push({ s: b.i("bg"), m: "opacity", start: 0, k: g.la });
      }
      b.i("video-holder").innerHTML = b.Gd;
      b.Ya ? (b.N("flipper", "flipped"), setTimeout(a, g.M)) : b.pa(c, g.M, a);
    });
    ...
    h.prototype.time_event = h.prototype.yd;
    h.prototype.track = h.prototype.I;
    h.prototype.track_links = h.prototype.Bd;
    h.prototype.track_forms = h.prototype.Ad;
    ...
    h.prototype.name_tag = h.prototype.hd;
    ...
    o.prototype.get_cross_subdomain = o.prototype.ad;
    ...
    p.prototype.track_charge = p.prototype.zd;
    p.prototype.clear_charges = p.prototype.Rc;
    p.prototype.delete_user = p.prototype.Tc;
